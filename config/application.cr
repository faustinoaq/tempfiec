...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Tempfiec web application."
  #
  #
  ...
  #
  # settings.secret_key_base= HgHXqZIIJTFiadlVeHU3wm93cQ4NnXtMWFayr_1qo1c
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("tempfiec.log", "w"))
  #
  #
end
